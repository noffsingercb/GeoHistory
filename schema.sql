...
--   scope gains 'universal', founding_kind gains 'institution', and four columns are
--   appended: coord_source, category_root, wikidata_types, sitelinks. New columns are
--   appended at the END on purpose so positional readers of older files keep working.
CREATE TABLE IF NOT EXISTS events (
  ...
  founding_kind  TEXT CHECK (founding_kind IN ('settlement','institution','subnational','country')),  -- founding sub-type (rescope-foundings.ts); overrides the scope ladder
